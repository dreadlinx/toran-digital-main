...
htmlFiles.forEach(f => {
  ...
  if (url === 'https://torandigital.co.za/') {
    priority = '1.0';
    changefreq = 'weekly';
  } else if (urlPath.startsWith('services/') || urlPath.startsWith('web-design/') || urlPath.startsWith('vehicle-branding/') || urlPath.startsWith('mobile-apps/')) {
    priority = '0.9';
    changefreq = 'weekly';
...
console.log(`Successfully generated sitemap.xml with ${urlEntries.length} canonical URLs!`);
